...
if __name__ == "__main__":
    ...
    URL = 'https://search.naver.com/search.naver?ssc=tab.image.all&where=image&sm=tab_jum&query='
    ...
    # 클래스 속성을 가져옵니다.
        ...
        # 클래스 속성이 정확히 ['_fe_image_tab_content_thumbnail_image']인 경우에만 리스트에 추가합니다.
        if class_attr == ['_fe_image_tab_content_thumbnail_image']:
    ...
    for i in range(len(image_info_list)):
        ...
        if 'src' in image_info_list[i].attrs:
            ...
            image_path = os.path.join(query + '_' +'naver'+ str(downlaod_cnt) + '.jpg')
